...
class Interceptor extends \Smile\ElasticsuiteVirtualCategory\Controller\Router implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ActionFactory $actionFactory, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Store\Model\StoreManagerInterface $storeManager, \Smile\ElasticsuiteVirtualCategory\Model\Url $urlModel, \Smile\ElasticsuiteVirtualCategory\Model\VirtualCategory\Root $virtualCategoryRoot)
    {
        $this->___init();
        parent::__construct($actionFactory, $eventManager, $storeManager, $urlModel, $virtualCategoryRoot);
    }
